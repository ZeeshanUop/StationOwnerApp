...
import '../Booking/bookingSlipscreen.dart';
  ...
  Future<void> updateBookingStatus(String bookingId, String status, String notificationId) async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(notificationId)
          .update({'type': status, 'status': 'unread'}); // mark unread so user sees update
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final status = data['status'] ?? 'unread'; // read/unread
              ...
              final timeStyle = TextStyle(
                fontSize: 13,
                color: isUnread ? Colors.teal.shade700 : Colors.grey.shade600,
